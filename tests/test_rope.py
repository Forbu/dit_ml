...
def test_rope_2d():
    ...
    # Initialize frequencies
    freqs_h, freqs_w = init_rope_frequencies(embedding_dim, 2, max_height=h, max_width=w)
...
def test_rope_3d():
    ...
    # Initialize frequencies
    freqs_h, freqs_w, freqs_d = init_rope_frequencies(embedding_dim, 3, max_height=h, max_width=w, max_depth=d)
    ...
    # Compute RoPE embeddings
    rope_tensor = compute_rope_embeddings((freqs_h, freqs_w, freqs_d), 3, dummy_tensor, h=h, w=w, d=d)
